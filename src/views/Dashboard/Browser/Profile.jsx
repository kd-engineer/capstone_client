      ...
      <ChakraProvider>
        <div id="content">
          <Container maxW="1200px">
            <Box h="200" bg="#fff" borderRadius="md" p="4">
              <Image
                borderRadius="full"
                boxSize="100px"
                objectFit="cover"
              ...
              <Text textAlign="center">kd@example.com</Text>
            </Box>
                ...
                <Box>
                  <Stack divider={<StackDivider />} spacing="4">
                    ...
                    <Box display="flex" alignItems="center">
                      <Avatar size="sm" mr="4" src={kd}></Avatar>
                      <Box mr="auto">
                ...
                <Box>
                  <Stack divider={<StackDivider />} spacing="4">
                    ...
                    <Box>
                      ...
                      post media
                      <Image objectFit="cover" src={kd} />
                      <Box p="5">
                        <p>
                          post likes ? "person likes " : "people like " "" this
                        </p>
                      </Box>
                      <Box>
